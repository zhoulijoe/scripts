...
IPA_NAME=${ARCHIVE_NAME}-${VERSION}-${ARCHIVE_SCHEME}-${BUILD_ID}_${BUILD_NUMBER}
XCARCHIVE_NAME=${ARCHIVE_NAME}-${VERSION}-${ARCHIVE_SCHEME}-${BUILD_ID}_${BUILD_NUMBER}.xcarchive
ARCHIVE_ROOT_DIR=${WORKSPACE}/build/${ARCHIVE_SCHEME}
PRODUCT_NAME=FamilyBase
